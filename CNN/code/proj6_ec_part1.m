function [net, info] = proj6_ec_part1()
%code for Computer Vision, Georgia Tech by James Hays
%based off the MNIST and CIFAR examples from MatConvNet

% This file has been modified for the purposes of classifiying the
% Human Object Sketches dataset
...
if exist(imdb_filename, 'file')
  ...
  imdb = proj6_ec_part1_setup_data();
