...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(11,11,1,16, 'single'), zeros(1, 16, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'conv1') ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,32,128, 'single'), zeros(1,64, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 1, ...
                           'name', 'conv3') ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,128,15, 'single'), zeros(1, 15, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'fc1') ;
